...
export default function Galerialoca() {
  return (
    ...
    <div className="flex min-h-96 items-center justify-center bg-slate-200 w-96"> {/* Abren imagenes */}
        ...
        <div className="flex [&:hover>div]:w-16 [&>div:hover]:w-[30rem]">
            ...
            <div className="invisible absolute inset-0 bg-gradient-to-b from-gray-500/20 to-black group-hover:visible">
              <div className="absolute inset-x-5 bottom-6">
                <div className="flex gap-3 text-white">
                  ...
                  <div>
                    <p className="font-sembold text-xl text-gray-100">Beneficio</p>
          ...
          <div className="group relative h-96 w-16 cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-200">
            <img
              ...
              alt=""
            />
            <div class="invisible absolute inset-0 bg-gradient-to-b from-teal-500/20 to-black group-hover:visible">
              <div class="absolute inset-x-5 bottom-6">
                <div class="flex gap-3 text-white">
                  ...
                  <div>
                    <p class="font-sembold text-xl text-gray-100">Beneficio</p>
